...
const FinanceHeader = ({ sidebarOpen, setSidebarOpen }) => {
  ...
  const [notifications, setNotifications] = useState([
    { 
      ...
      message: 'Successfully processed 150 employee payroll records.',
      time: '5 min ago', 
      isRead: false,
      type: 'success',
      detail: 'All records were processed successfully. 2 records had warnings.'
    },
    { 
      id: 2, 
      title: 'Budget Alert', 
      message: 'Marketing budget exceeded by 15% this quarter.',
      time: '1 hour ago', 
      isRead: false,
      type: 'alert',
      detail: 'Current spending: $115,000 of $100,000 budget.'
    },
    { 
      id: 3, 
      title: 'New Invoice Received', 
      message: 'Invoice #INV-2024-045 from Tech Solutions Inc.',
      time: '3 hours ago', 
      isRead: true,
      type: 'info',
      detail: 'Amount: $25,750. Due date: March 30, 2024.'
    },
  ]);
        ...
        <div className="flex h-16 items-center justify-between px-4 md:px-6">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="relative hidden md:block">
              ...
              <input
                ...
                className="w-80 pl-10 pr-12 py-2 border border-gray-200 rounded-lg bg-white/90 backdrop-blur-sm focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 dark:border-gray-600 dark:bg-gray-800/90 dark:text-white"
              />
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="relative">
              ...
              >
                {theme === 'light' ? <Sun className="h-5 w-5 text-yellow-500" /> : theme === 'dark' ? <Moon className="h-5 w-5 text-blue-400" /> : <Monitor className="h-5 w-5 text-gray-600 dark:text-gray-400" />}
              </button>
              ...
              {themeOpen && (
                <div ref={themeDropdownRef} className="absolute right-0 mt-2 w-48 rounded-2xl border border-gray-200 bg-white shadow-lg dark:border-gray-700 dark:bg-gray-800">
                  <div className="p-2">
                    ...
                    >
                      <Monitor className={`h-4 w-4 text-gray-600 dark:text-gray-400 transition-colors duration-200 ${
            ...
            <div className="relative" ref={profileDropdownRef}>
              ...
              >
                ...
                <span className="hidden md:block text-sm font-medium text-gray-700 dark:text-gray-300">Sarah Chen</span>
                ...
                <div className="absolute right-0 mt-2 w-64 rounded-2xl border border-gray-200 bg-white shadow-lg dark:border-gray-700 dark:bg-gray-800">
                  <div className="p-4">
                    ...
                    <div className="space-y-2">
                      ...
                      <button className="flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium text-red-600 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-900/20 transition-colors duration-200 w-full text-left">
          ...
          <div className="w-full max-w-2xl bg-white rounded-2xl shadow-2xl border border-gray-200 dark:bg-gray-800 dark:border-gray-700 overflow-hidden">
            <div className="p-4 border-b border-gray-200 dark:border-gray-700">
              <div className="flex items-center gap-3">
                ...
                <input
                  type="text"
                  placeholder="Search for transactions, employees, reports..."
            ...
            <div className="max-h-96 overflow-y-auto">
              <div className="p-4">
                <div className="text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider mb-3">Quick Actions</div>
                <div className="space-y-2">
                  <button className="w-full text-left p-3 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors">
                    <div className="flex items-center gap-3">
                      <FileText className="h-4 w-4 text-blue-500" />
                      <div>
                        <div className="text-sm font-medium text-gray-900 dark:text-white">Import Payroll</div>
                        <div className="text-xs text-gray-500 dark:text-gray-400">Upload CSV file for payroll processing</div>
                      </div>
                    </div>
                  </button>
                  <button className="w-full text-left p-3 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <div className="text-sm font-medium text-gray-900 dark:text-white">Add Employee</div>
                        <div className="text-xs text-gray-500 dark:text-gray-400">Create new employee profile</div>
                      </div>
                    </div>
                  </button>
                </div>
