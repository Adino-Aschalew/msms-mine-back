                  ...
                  >
                    <div className="flex items-start space-x-3">
                      <div className={`p-2 rounded-full ${
                        typeColor === 'green' ? 'bg-green-100 dark:bg-green-900/20' :
                        typeColor === 'yellow' ? 'bg-yellow-100 dark:bg-yellow-900/20' :
                        typeColor === 'red' ? 'bg-red-100 dark:bg-red-900/20' :
                        typeColor === 'blue' ? 'bg-blue-100 dark:bg-blue-900/20' :
                        'bg-gray-100 dark:bg-gray-700'
                      }`}>
                        <Icon className={`h-5 w-5 ${
                          typeColor === 'green' ? 'text-green-600 dark:text-green-400' :
                          typeColor === 'yellow' ? 'text-yellow-600 dark:text-yellow-400' :
                          typeColor === 'red' ? 'text-red-600 dark:text-red-400' :
                          typeColor === 'blue' ? 'text-blue-600 dark:text-blue-400' :
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="flex items-center justify-between mt-2">
                          <span className={`text-xs px-2 py-1 rounded ${
                            typeColor === 'green' ? 'bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-400' :
                            typeColor === 'yellow' ? 'bg-yellow-100 text-yellow-800 dark:bg-yellow-900/30 dark:text-yellow-400' :
                            typeColor === 'red' ? 'bg-red-100 text-red-800 dark:bg-red-900/30 dark:text-red-400' :
                            typeColor === 'blue' ? 'bg-blue-100 text-blue-800 dark:bg-blue-900/30 dark:text-blue-400' :
                            'bg-gray-100 text-gray-800 dark:bg-gray-700 dark:text-gray-400'
                          }`}>
              ...
              return (
                <div key={setting.id} className="flex items-center justify-between p-4 border border-gray-200 dark:border-gray-700 rounded-lg">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <h3 className="text-sm font-medium text-gray-900 dark:text-white">{setting.category}</h3>
