-- ====================================================================
-- Microfinance & Savings Management System (MSMS)
-- Complete Database Schema
-- Engine: MySQL 8.0+
-- Version: 3.0 - Full Production Schema
--
-- LOGIN RULES (matches frontend + backend):
--   EMPLOYEES        -> login with Employee ID  (e.g. EMP001)
--   ALL OTHER ROLES  -> login with email address
--
-- DEFAULT CREDENTIALS (all verified bcrypt hashes):
--   admin@msms.com          / Admin@2026   (ADMIN)
--   superadmin@msms.com     / Admin@2026   (SUPER_ADMIN)
--   hr@msms.com             / password     (HR)
--   finance@msms.com        / password     (FINANCE_ADMIN)
--   loancommittee@msms.com  / password     (LOAN_COMMITTEE)
--   EMP001                  / password     (EMPLOYEE)
-- ====================================================================

-- ====================================================================
-- 0. DATABASE SETUP
-- ====================================================================
CREATE DATABASE IF NOT EXISTS microfinance_system
...
-- Loans (Active Loan Records - created after approval & disbursement)
...
-- Loan Repayments (scheduled + actual)
...
-- Payroll Details (Per-employee record in a payroll batch)
...
-- Generated Reports (stored report metadata)
...
-- ====================================================================
-- SECTION 7: COMMUNICATIONS / NOTIFICATIONS
-- ====================================================================
...
-- -----------------------------------------------------------------------
-- 8b. Default Users
-- All real bcrypt hashes generated with 12 salt rounds:
--   'Admin@2026' => $2a$12$3vrgkj5a6NA8J44HJ5H1AeG5JzQKUlaAEdGxSK2pVXPTfB32AghWm
...
-- 2. HR Manager (login: hr@msms.com / password)
INSERT INTO users (employee_id, username, email, password_hash, role, is_active, email_verified, first_name, last_name)
VALUES ('HR001', 'hr@msms.com', 'hr@msms.com',
        '$2a$12$A233dQjDh42aflzqUNiOZ.7oGI3Iw0h0jLav891EVw1qey8JPRWoW',
        'HR', TRUE, TRUE, 'HR', 'Manager');

-- 3. Finance Admin (login: finance@msms.com / password)
INSERT INTO users (employee_id, username, email, password_hash, role, is_active, email_verified, first_name, last_name)
VALUES ('FIN001', 'finance@msms.com', 'finance@msms.com',
        '$2a$12$A233dQjDh42aflzqUNiOZ.7oGI3Iw0h0jLav891EVw1qey8JPRWoW',
        'FINANCE_ADMIN', TRUE, TRUE, 'Finance', 'Manager');

-- 4. Loan Committee Chair (login: loancommittee@msms.com / password)
INSERT INTO users (employee_id, username, email, password_hash, role, is_active, email_verified, first_name, last_name)
VALUES ('LOAN001', 'loancommittee@msms.com', 'loancommittee@msms.com',
        '$2a$12$A233dQjDh42aflzqUNiOZ.7oGI3Iw0h0jLav891EVw1qey8JPRWoW',
        'LOAN_COMMITTEE', TRUE, TRUE, 'Loan', 'Committee');

-- 5. Employee (login: EMP001 / password)
INSERT INTO users (employee_id, username, email, password_hash, role, is_active, email_verified, first_name, last_name)
VALUES ('EMP001', 'EMP001', 'john.doe@msms.com',
        '$2a$12$A233dQjDh42aflzqUNiOZ.7oGI3Iw0h0jLav891EVw1qey8JPRWoW',
        'EMPLOYEE', TRUE, TRUE, 'John', 'Doe');


-- -----------------------------------------------------------------------
-- 8c. Employee Profiles (one for every user above)
-- -----------------------------------------------------------------------
INSERT INTO employee_profiles
    (user_id, employee_id, first_name, last_name, department, job_grade,
     employment_status, hire_date, hr_verified, hr_verification_date)
VALUES
    (1, 'ADMIN001',  'System',  'Administrator', 'IT',              'ADMIN',            'ACTIVE', '2024-01-01', TRUE, NOW()),
    (2, 'HR001',     'HR',      'Manager',       'Human Resources', 'MANAGER',          'ACTIVE', '2024-01-01', TRUE, NOW()),
    (3, 'FIN001',    'Finance', 'Manager',       'Finance',         'MANAGER',          'ACTIVE', '2024-01-01', TRUE, NOW()),
    (4, 'LOAN001',   'Loan',    'Committee',     'Loans',           'CHAIR',            'ACTIVE', '2024-01-01', TRUE, NOW()),
    (5, 'EMP001',    'John',    'Doe',           'Engineering',     'SENIOR_DEVELOPER', 'ACTIVE', '2024-01-15', TRUE, NOW());


-- -----------------------------------------------------------------------
-- 8d. Default Savings Account for the Employee
-- -----------------------------------------------------------------------
INSERT INTO savings_accounts (user_id, employee_id, saving_percentage, current_balance, account_status)
VALUES (5, 'EMP001', 25.00, 0.00, 'ACTIVE');
...
-- SCHEMA COMPLETE
-- ====================================================================
SELECT 'MSMS Database Schema v3.0 Created Successfully' AS status;

-- ====================================================================
-- QUICK REFERENCE
-- ====================================================================
-- Login rules (enforced by backend auth.service.js):
--   EMPLOYEE role   → use Employee ID  (stored in users.employee_id)
--   All other roles → use email address (stored in users.email)
--
-- Default credentials (use exactly as shown):
-- ┌─────────────────────────────────┬────────────────┬───────────────┐
