...
//       user_data: userData,
//       financials: {
//         salary: financials?.salary || 0,
//         savings_balance: financials?.savings_balance || 0,
//         max_loan_by_savings: (financials?.savings_balance || 0) * 2,
//         max_monthly_repayment: (financials?.salary || 0) * 0.33
//       }
//     };
//   }
...
//         ep.department,
//         ep.salary,
//         (SELECT COUNT(*) FROM guarantors WHERE guarantor_employee_id = ? AND status = 'ACTIVE') as active_guarantees
//       FROM users u
